...
export function SettingsModal({ onClose }: SettingsModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-10 flex items-center justify-center z-10">
      <div className="bg-white rounded-lg w-full max-w-[90vw] sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-5xl max-h-[85vh] overflow-hidden shadow-lg flex flex-col">
