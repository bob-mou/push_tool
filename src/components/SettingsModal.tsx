...
import { X, Settings as SettingsIcon, Bell, Play, FolderOpen, FileCog, RefreshCcw, CheckCircle2, XCircle, Route, History } from 'lucide-react';
...
export function SettingsModal({ onClose }: SettingsModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg w-full max-w-md max-h-[80vh] shadow-xl flex flex-col">
        <div className="flex items-center justify-between p-6 border-b electron-drag">
